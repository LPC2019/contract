...
$config->contract->editor->create   = array('id' => 'description', 'tools' => 'simpleTools');
$config->contract->editor->edit     = array('id' => 'description', 'tools' => 'simpleTools');
$config->contract->editor->view     = array('id' => 'comment,lastComment', 'tools' => 'simpleTools');
$config->contract->editor->createinvoice   = array('id' => 'description', 'tools' => 'simpleTools');


$config->invoice->editor = new stdclass();
$config->invoice->editor->create   = array('id' => 'description', 'tools' => 'simpleTools');
$config->invoice->editor->edit     = array('id' => 'description', 'tools' => 'simpleTools');
$config->invoice->editor->view     = array('id' => 'comment,lastComment', 'tools' => 'simpleTools');
