  ...
  <div class='center-block'>
    ...
    <div class='main-header'>
      <h2>
        ...
        <?php // if(!isonlybody()):?>
        <small> <?php echo html::a($this->createLink('product', 'view', 'asset=' . $asset->id), $asset->name).$lang->arrow.html::a($this->createLink('contract', 'view', 'asset=' . $contract->id), $contract->contractName).$lang->arrow .$lang->arrow.html::a($this->createLink('contract', 'Invoiceview', 'invoice=' . $invoice->id), $invoice->id).$lang->arrow . $lang->invoice->reject;?></small>
        <?php //endif;?>
      </h2>
    </div>
