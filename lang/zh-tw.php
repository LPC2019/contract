...
//added
$lang->project->location            = "{$lang->projectCommon}地點"; //emsd map
$lang->project->map                 = $lang->mapCommon; //emsd map

$lang->product->plans       = '計劃數';
$lang->product->releases    = '發佈數';
$lang->product->docs        = '文檔數';
$lang->product->bugs        = "相關{$lang->bugCommon}";
...
$lang->product->unResolvedBugs        = "未解決{$lang->bugCommon}";
$lang->product->unResolvedBugsTitle   = "未解決{$lang->bugCommon}";
$lang->product->assignToNullBugs      = "未指派{$lang->bugCommon}";
$lang->product->assignToNullBugsTitle = "未指派{$lang->bugCommon}";
